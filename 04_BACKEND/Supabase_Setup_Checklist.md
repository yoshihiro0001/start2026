...
- [ ] Supabase accountへログイン
- [ ] New projectを作成
- [ ] Project name: `start2026` など分かる名前にする
- [ ] Regionを選ぶ
- [ ] Database passwordをPassword Managerへ保存
- [ ] Project URLを確認
- [ ] anon keyを確認
- [ ] service_role keyを確認するが、Gitへ保存しない
...
Supabase project作成後、`tasks` と `approvals` を作り、Human ConsoleからPending Approvalを読める状態へ進める。
